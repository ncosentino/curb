...
/// hand-maintained table falls behind silently, and the failure mode is Curb reporting a rule it
...
public class RuleCatalogTests
{
	...
	[Test]
	public async Task The_rules_curb_already_formats_are_not_claimed_as_cleanup()
	{
