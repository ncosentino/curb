...
/// <remarks>
/// <para>
/// This is Curb's always-on safety net: O(n), allocation-free, and no re-parse. If it fails, the
...
/// </para>
/// <para>
/// Reordering usings is the one thing Curb does that legitimately changes the order of content, so
