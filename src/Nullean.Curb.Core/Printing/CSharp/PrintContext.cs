...
internal sealed class PrintContext(DocArena arena, SourceText text, FormatOptions options)
{
	...
	/// <summary>The author put a break between these positions, and Curb honours it.</summary>
	/// <remarks>
	/// <para>
	...
	/// Curb decides. Routing every such question through a named predicate is what makes the rule
	...
	/// <summary>The author kept these positions on one line, and Curb honours it.</summary>
	...
	/// <c>csharp_keep_blank_lines_in_declarations</c>. Both default to leaving Curb where it was: a
