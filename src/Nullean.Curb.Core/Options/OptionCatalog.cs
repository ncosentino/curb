...
/// <summary>
/// Every <c>.editorconfig</c> key Curb recognises, and whether it is wired up yet.
/// </summary>
/// <remarks>
/// <para>
/// The point of separating "known" from "implemented" is honesty. Curb onboards formatting options
/// one at a time, and a user whose <c>.editorconfig</c> sets an option Curb has not reached yet
...
public static class OptionCatalog
{
	...
	/// <summary>Keys Curb actually acts on today. Everything else in the catalog reports CURB1003.</summary>
	public static readonly FrozenSet<string> ImplementedKeys =
		CoreKeys.Concat([
			// ReSharper's keys, not Curb's. Curb invents no formatting keys: Rider has held this
